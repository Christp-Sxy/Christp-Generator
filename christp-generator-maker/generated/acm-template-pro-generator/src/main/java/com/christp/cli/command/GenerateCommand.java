...
public class GenerateCommand implements Callable<Integer> {
    ...
    @Option(names = {"--FreeMarker template error (DEBUG mode; use RETHROW in production!):
The following has evaluated to null or missing:
==> modelInfo.fieldName  [in template "GenerateCommand.java.ftl" at line 17, column 77]
...
FTL stack trace ("~" means nesting-related):
	- Failed at: ${modelInfo.fieldName}  [in template "GenerateCommand.java.ftl" at line 17, column 75]
----
...
freemarker.core.InvalidReferenceException: [... Exception message was already printed; see it above ...]
	...
	at com.christp.maker.generator.main.MainGenerator.main(MainGenerator.java:60)
